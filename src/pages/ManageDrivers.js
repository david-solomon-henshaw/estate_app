...
//     try {
//       const s3Response = await fetch('https://flask-backend-estate.onrender.com/api/residents/api/upload', {
//         method: 'POST',
//         body: formData,
//       });
...
//     try {
//       const response = await fetch("https://flask-backend-estate.onrender.com/api/residents/api/drivers", {
//         method: "POST",
//         headers: {
